          ...
          <div className="relative mx-auto max-w-7xl px-5 py-20 sm:px-6 lg:px-12 lg:py-28">
            <div className="grid gap-10 text-center lg:grid-cols-[1.1fr_0.9fr] lg:items-center lg:text-left">
              <div>
                ...
                <h1 className="mx-auto mt-5 max-w-[22rem] text-[clamp(2.45rem,10vw,5.6rem)] font-bold leading-[1.15] tracking-[-0.04em] sm:max-w-none lg:mx-0">
                  物流業務を、
                  <br />
                  まとめて任せる。
                </h1>

                <p className="mx-auto mt-7 max-w-[24rem] text-[15px] leading-[2.05] text-white/82 sm:max-w-3xl sm:text-lg sm:leading-9 lg:mx-0">
          ...
          <div className="mx-auto max-w-7xl px-5 text-center sm:px-6 lg:px-12 lg:text-left">
            ...
            <div className="mt-10 grid gap-6 text-left md:grid-cols-2 xl:grid-cols-4">
              {serviceCards.map((service) => (
                <div key={service.title} className="tech-card rounded-[2rem] p-7">
          ...
          <div className="mx-auto max-w-7xl px-5 text-center sm:px-6 lg:px-12 lg:text-left">
            <div className="grid gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-start">
              <div>
                ...
                <p className="mx-auto mt-6 max-w-[34rem] text-[15px] leading-8 text-white/70 sm:text-base lg:mx-0">
